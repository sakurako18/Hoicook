...
Recipe.create!([
  { user_id:1 ,genre_id:2, name: '麻婆豆腐', introduction: 'ひき肉たっぷり、辛くない麻婆豆腐です', number_of_people: '4', how_to_make: '１，具材を切って、フライパンに入れる。\r\n２，炒めてから調味料で味付けをする。\r\n３，水溶き片栗粉を入れてとろみをつけて完成！', post_status: 'true', created_at: 'Sat, 24 Jun 2023 07:29:13.536560000 JST +09:00', image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-recipe1.jpg"), filename: "sample-recipe1.jpg")},
